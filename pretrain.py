...
# python pretrain.py --model_type="LightweightOpenpose" --model_backbone="Vgg19"
# --model_name="default_name" --dataset_path="./data"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_type",
                        type=str,
                        default="Openpose",
                        help="human pose estimation model type, "
                             "available options: Openpose, LightweightOpenpose ,MobilenetThinOpenpose, PoseProposal")
    parser.add_argument("--model_backbone",
                        type=str,
                        default="Default",
                        help="model backbone, available options: "
                             "Mobilenet, Vggtiny, Vgg19, Resnet18, Resnet50")

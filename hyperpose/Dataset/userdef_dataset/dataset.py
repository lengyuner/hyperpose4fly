...
from .define import UserdefPart,UserdefColor    #CocoPart,CocoColor
...
class Userdef_dataset(Base_dataset):
    ...
    def __init__(self,config,input_kpt_cvter=None,output_kpt_cvter=None,dataset_filter=None):
        ...
        self.parts=UserdefPart
        self.colors=UserdefColor
        ...
        print(f"using userdef dataset version:{self.dataset_version}")

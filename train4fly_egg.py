...
dataset_path = "./data/egg"
train_type = "Single_train"
kf_optimizer ='Sync_avg'
userdef_dataset = 1
useradd_data_path = "./data/egg"
...
config.model.win = 48*2#TODO
config.model.hout = 6*2 #48/8
config.model.wout = 6*2 #64/8#TODO
...
# C:\Users\ps\Desktop\djz\hyperpose\save_dir\well_done
